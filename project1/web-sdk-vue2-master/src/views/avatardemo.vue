  ...
  <div class="avatar">
    <el-container>
      <el-aside width="200px" height="840px">
        <el-row>
          <el-button type="primary" @click="switchAvatar">切换到风屿</el-button>
  ...
  data() {
    return {
      ...
      setglobalparamsform: {
        ...
        avatar: {
          avatar_id: "111051001",//（必传）授权的形象资源id，请到交互平台-接口服务-形象列表中获取
        ...
        tts: {
          vcn: "x4_mingge",//（必传）授权的声音资源id，请到交互平台-接口服务-声音列表中获取
          speed: 50,//（非必传）语速
          pitch: 50,//（非必传）语调
          volume: 100,//（非必传）音量
